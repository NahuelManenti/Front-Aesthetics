...
export default function Check() {
  ...
  return (
    <Transition.Root show={checkout} as={Fragment}>
      <Dialog as="div" className="carrito relative z-10" onClose={() => handleCheckout(false)}>
        <Transition.Child
          as={Fragment}
                ...
                <Dialog.Panel className="pointer-events-auto w-screen max-w-md">
                  <div className="flex h-full flex-col overflow-y-scroll bg-white shadow-xl">
                                  ...
                                  <div className="flex flex-1 items-end justify-between text-sm">
                                    ...
                                    <div className="flex">
                                      <button
                                        ...
                                        onClick={() => dispatch(checkoutActions.deleteProduct(product))}
                                      >
                                        Remove
                                      </button>
                                    </div>
                    ...
                    <div className="border-t border-gray-200 py-6 px-4 sm:px-6">
                      ...
                      <p className="mt-0.5 text-sm text-gray-500">Los gastos de envío y los impuestos se calculan en el momento de la compra.</p>
                      <div className="mt-6">
                        <LinkRouter className="flex items-center justify-center rounded-md border border-transparent bg-indigo-600 px-6 py-3 text-base font-medium text-white shadow-sm hover:bg-indigo-700" to={`/shipping`} onClick={() => handleCheckout(false)}>
                          Comprar
                        </LinkRouter>
                        {/* <a
                          href="#"
