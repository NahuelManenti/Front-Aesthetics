...
export default function AdminAddNews() {
  ...
  let messageAlert = '¡Novedad Cargada!'
  ...
  async function handleCreation(event) {
    ...
    formData.append('name', await newsName)
    formData.append('description', await newsDescription)
    formData.append('idUser', await idUser)
    formData.append('file', file)
    await dispatch(newsActions.addNews(formData))
    setAlert(!alert)
    setReload(!reload)
  }
          ...
          <div className="md:col-span-1">
            <div className="px-4 sm:px-0 mt-2">
              ...
              <p className="mt-1 text-sm text-gray-600">
                ¡Aquí podrás agregar novedades a tu tienda!
              </p>
            </div>
          </div>
                ...
                <div className="px-4 py-4 bg-white space-y-6 sm:p-6">
                  <div className="grid grid-cols-3 gap-6">
                    <div className="col-span-3 sm:col-span-2">
                      <h3 className="text-lg font-medium leading-6 text-gray-900">Agregar novedad</h3>
